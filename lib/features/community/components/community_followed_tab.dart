...
class CommunityFollowedTab extends StatefulWidget {
  const CommunityFollowedTab({super.key});

  @override
  State<CommunityFollowedTab> createState() => _CommunityFollowedTabState();
}
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    ySpace(height: 20),
                    subtext(
                      "Communities you've followed, will appear here",
                      fontSize: 14,
                  ...
                  return [
                    PopupMenuItem(
                      ...
                      child: Row(
                        ...
                        children: [
                          subtext("Unfollow this conversation"),
                        ],
                      ),
                    ),
                    PopupMenuItem(
