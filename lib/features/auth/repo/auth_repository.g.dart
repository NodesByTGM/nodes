...
class _AuthRepository implements AuthRepository {
  ...
  @override
  Future<ApiResponse> onboarding(dynamic payload) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = payload;
  ...
  @override
  Future<ApiResponse> verifyBusiness(dynamic payload) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = payload;
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://dev.api.nodesafrica.com/api/v1/onboarding/verify-business',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  @override
  Future<ApiResponse> updateBusinessProfile(dynamic payload) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = payload;
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://dev.api.nodesafrica.com/api/v1/users/business-profile',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<ApiResponse> fetchAllMyTransactions() async {
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://dev.api.nodesafrica.com/api/v1/transactions/mine',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
