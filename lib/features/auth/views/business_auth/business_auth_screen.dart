...
class BusinessAuthScreen extends StatefulWidget {
  ...
  static const String routeName = "/businessAuthScreen";
...
class _BusinessAuthScreenState extends State<BusinessAuthScreen> {
        ...
        children: [
          ...
          Align(
            ...
            child: GestureDetector(
              onTap: () {
                navigateAndClearPrev(context, TalentSignupScreen.routeName);
              },
              child: labelText(
                "Sign up as a talent instead?",
                fontSize: 16,
                fontWeight: FontWeight.w400,
              ),
            ),
  ...
  void _submit() async {
    navigateTo(context, BusinessSignupScreen.routeName);
  }
}
